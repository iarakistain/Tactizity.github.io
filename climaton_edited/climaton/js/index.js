...
var marker_0 = L.marker([43.18602602691476,  -2.481862145552043]).addTo(map).on('click', onClick); //Wenceslao Orbea

var marker_0 = L.marker([43.18446774285371,  -2.4821571996042167]).addTo(map).on('click', onClick); //Ziriako Agirre

var marker_0 = L.marker([43.18392169669383,  -2.4830970453033956]).addTo(map).on('click', onClick); //Asola Igartza

var marker_0 = L.marker([43.18162324266106,  -2.4857964202926155]).addTo(map).on('click', onClick); //Tiburcio Anitua 21

var marker_0 = L.marker([43.18092852607501,  -2.487841336169936]).addTo(map).on('click', onClick); //Tiburcio Anitua 25


var marker_0 = L.marker.movingMarker(
    recorrido,
    10000, {autostart: true}).addTo(map);

marker_0.addStation(1, 2000);
marker_0.addStation(2, 2000);
marker_0.addStation(3, 2000);
marker_0.addStation(4, 2000);
